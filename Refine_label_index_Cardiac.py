...
def Rename_predictions(datalist, data_fd, renamed_data_fd, contrast):
    ...
    for k in range(len(images_list)):
        ...
        id_before_r = 'step' + epoch + '_' + contrast + '_fudan_' + str(k) + '.mat'
...
if __name__ == '__main__':
    ...
    # datalist        = '/home/compu/HG/CrossModa/DRANet-master/DRANet-master/data_list/FUDAN/mr/train_mr.txt'   
    # contrast        =  'mr'
    
    datalist        = '/home/compu/HG/CrossModa/DRANet-master/DRANet-master/data_list/FUDAN/ct/train_ct.txt'   
    contrast        =  'ct'
    
    
    
    data_fd          = '/data/COSMOS_v2_preddir/TIME_DEEP_FUDAN_MR_CT_V4_Large_IDT_P4'
